     ...
     <div class="col-md-2">
         ...
         <div class="list-group">
           <a href="<?php echo site_url('web/buscar_tipos')?>" class=" list-group-item">Tipo</a>
             ...
             <a href="<?php echo site_url('web/buscar_tamanos')?>" class="active list-group-item">Tamaño de Aro</a>
...
<br /><br />
           <div class="form-group">
             <label for="">Seleccione el Tamaño de Aro que desea buscar</label>
             <select required class="form-control" name="tamanoAro" id="tamanoAro">
               <option></option>
